...
\begin{equation*}
    \begin{aligned}
       \frac{3x^2}{4} \cdot 4 & = (e^{12} - 1) \cdot 4 &  (\text{Inverse of dividing by 4 is multiplying by 4}) \\  
        ...
        x & = \pm \sqrt{\frac{4}{3} (e^{12} - 1)}
    \end{aligned}
\end{equation*}
Notice there are two possible solutions to this equation: $x = \sqrt{\frac{4}{3} (e^{12} - 1)}$, 
and $x = -\sqrt{\frac{4}{3} (e^{12} - 1)}$. This is because, whether $x$ is positive or negative, 
$x^2$ is always positive, so squaring either solution gives the same result. In general, whenever 
you take an even root (square root, 4th root, 6th root, etc.) of an even power, you must add a 
$\pm$ to the solution unless the problem tells you $x > 0$ or $x < 0$.
